...
public class PlannerValidationSpecification : IValidationSpecification<Planner>
{
    public void IsValid(Planner entity)
    {
    ...
    private class PlannerValidator : AbstractValidator<Planner>
    {
        public PlannerValidator()
        {
            // ClientId
            ...
            // AgendaType
            RuleFor(x => x.PlannerType)
                .IsInEnum().WithMessage("O campo 'PlannerType' está inválido.");
